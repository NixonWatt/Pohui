...
{
    public static class LuceneTagSearch
    {
        ...
        private static FSDirectory directory
        {
            get
            {
                ...
                var lockFilePath = Path.Combine(luceneDir, "tagWrite.lock");
                if (File.Exists(lockFilePath)) File.Delete(lockFilePath);
                return directoryTemp;
            }
        }
        private static void addToLuceneIndex(Tag Data, IndexWriter writer)
        {
        ...
        public static void AddUpdateLuceneIndex(IEnumerable<Tag> sampleDatas)
        {
        ...
        public static void AddUpdateLuceneIndex(Tag sampleData)
        {
            AddUpdateLuceneIndex(new List<Tag> { sampleData });
        }
        ...
        {
            if (!System.IO.Directory.EnumerateFiles(luceneDir).Any()) return new List<Tag>();
